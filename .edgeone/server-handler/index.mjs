...
} from './netlify/temp/eo-next-test/.edgeone/dist/run/handlers/request-context.cjs'
import { getTracer } from './netlify/temp/eo-next-test/.edgeone/dist/run/handlers/tracer.cjs'
import * as serverHandler from './netlify/temp/eo-next-test/.edgeone/dist/run/handlers/server.js'


process.chdir('./netlify/temp/eo-next-test')
...
export default async function eoHandler (req, context) {
  ...
  const handlerResponse = await runWithRequestContext(requestContext, () => {
    return tracer.withActiveSpan('Next.js Server Handler', async (span) => {
      if (!cachedHandler) {
        // const { default: handler } = await import('netlify/temp/eo-next-test/.edgeone/dist/run/handlers/server.js')
